...
def html():
    ...
    return render_template('randoms.html', numbers=ns, kma=Day_03_06_sqllite.fetchWhere('Data/kma.sqlite', '안동'))

@app.route('/kma')
def kma():
    pusan = Day_03_06_sqllite.fetchWhere('Data/kma.sqlite', '부산')
